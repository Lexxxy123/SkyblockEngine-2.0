...
public class FastTravelGUI extends GUI{
    ...
    public void onOpen(GUIOpenEvent e) {
        ...
        set(new GUIClickableItem() {
            @Override
            public void run(InventoryClickEvent e) {
                player.sendMessage("Dungeon hub not added yet!");
//                Location loc = new Location(Bukkit.getWorld("DHub"), -45, 88, 13);
//                Player player1 = (Player) e.getWhoClicked();
//
//                if (player1 != null && loc.getWorld() != null) {
...
//                }
            ...
            public ItemStack getItem() {
                return SUtil.getSkullURLStack(ChatColor.GREEN + "Dungeon Hub " + ChatColor.DARK_GRAY + "- " + ChatColor.AQUA + "Spawn", "1035c528036b384c53c9c8a1a125685e16bfb369c197cc9f03dfa3b835b1aa55", 1,
                        ChatColor.DARK_GRAY + "/dungeon_hub",
                        " ",
        ...
        set(new GUIClickableItem() {
            ...
            public void run(InventoryClickEvent e) {
                Player player1 = (Player) e.getWhoClicked();
                World the_barn = Bukkit.getWorld("world");
        ...
        set(new GUIClickableItem() {
            ...
            public void run(InventoryClickEvent e) {
                Player player1 = (Player) e.getWhoClicked();
                World park = Bukkit.getWorld("world");
        ...
        set(new GUIClickableItem() {
            ...
            public void run(InventoryClickEvent e) {
                Player player1 = (Player) e.getWhoClicked();
                World gold_mine = Bukkit.getWorld("world");
        ...
        set(new GUIClickableItem() {
            ...
            public void run(InventoryClickEvent e) {
                Player player1 = (Player) e.getWhoClicked();
                World deep_caverns = Bukkit.getWorld("world");
        ...
        set(new GUIClickableItem() {
            ...
            public void run(InventoryClickEvent e) {
                Player player1 = (Player) e.getWhoClicked();
                World spider_mine = Bukkit.getWorld("world");
        ...
        set(new GUIClickableItem() {
            ...
            public void run(InventoryClickEvent e) {
                Player player1 = (Player) e.getWhoClicked();
                World the_end = Bukkit.getWorld("world");
        ...
        set(new GUIClickableItem() {
            ...
            public void run(InventoryClickEvent e) {
                Player player1 = (Player) e.getWhoClicked();
                World nether = Bukkit.getWorld("world");

package in.godspunky.skyblock.nms.nmsutil.reflection.annotation;

import in.godspunky.skyblock.nms.nmsutil.reflection.minecraft.Minecraft;
...
import in.godspunky.skyblock.nms.nmsutil.reflection.resolver.wrapper.ClassWrapper;
import in.godspunky.skyblock.nms.nmsutil.reflection.resolver.wrapper.FieldWrapper;
...
public class ReflectionAnnotations {
    ...
    public void load(final Object toLoad) {
        ...
        for (final java.lang.reflect.Field field : toLoad.getClass().getDeclaredFields()) {
            final Class classAnnotation = field.getAnnotation(Class.class);
            final Field fieldAnnotation = field.getAnnotation(Field.class);
            final Method methodAnnotation = field.getAnnotation(Method.class);

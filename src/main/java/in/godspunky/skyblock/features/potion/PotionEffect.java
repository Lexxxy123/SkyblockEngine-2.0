...
public class PotionEffect {
    ...
    public String getDescription() {
        if (this.type == PotionEffectType.STRENGTH) {
            return this.type.getDescription(SUtil.getOrDefault(Arrays.asList(5, 12, 20, 30, 40, 50, 60, 75), this.level - 1, this.level * 10));
        }
        ...
        if (this.type == PotionEffectType.HEALING) {
            return this.type.getDescription(SUtil.getOrDefault(Arrays.asList(20, 50, 100, 150, 200, 300, 400, 500), this.level - 1, (this.level - 3) * 100));
        }
        ...
        if (this.type == PotionEffectType.MANA) {
            return this.type.getDescription(SUtil.getOrDefault(Arrays.asList(25, 50, 75, 100, 150, 200, 300, 400), this.level - 1, (this.level - 4) * 100));
        }
        if (this.type == PotionEffectType.ADRENALINE) {
            return this.type.getDescription(SUtil.getOrDefault(Arrays.asList(20, 40, 60, 80, 100, 150, 200, 300), this.level - 1, (this.level - 5) * 100), this.level * 5);
        }
        ...
        if (this.type == PotionEffectType.ABSORPTION) {
            return this.type.getDescription(SUtil.getOrDefault(Arrays.asList(20, 40, 60, 80, 100, 150, 200, 300), this.level - 1, (this.level - 5) * 100));
        }
        if (this.type == PotionEffectType.RESISTANCE) {
            return this.type.getDescription(SUtil.getOrDefault(Arrays.asList(5, 10, 15, 20, 30, 40, 50, 60), this.level - 1, this.level * 10 - 20));
        }
        ...
        if (this.type == PotionEffectType.STAMINA) {
            return this.type.getDescription(SUtil.<Integer>getOrDefault(Arrays.asList(150, 215, 315, 515), this.level - 1, (this.level + 1) * 100 + 15), 50 * this.level);
        }

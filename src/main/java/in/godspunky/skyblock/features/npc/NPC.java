...
public class NPC implements Listener {
    ...
    public void spawn() {
        ...
        List<Object> npcData = SUtil.spawnSkyblockNpc(this.location, this.name, this.skinValue, this.skinSignature, this.hasSkin, this.doesLookClose, this.villager, this.profession);
    ...
    public static void sendMessages(Player player, String npc, String... messages) {
        ...
        for (String message : messages) {
            SUtil.delay(() -> sendMessage(player, npc, message), i * 20);
            i++;
        }

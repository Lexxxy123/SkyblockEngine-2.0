...
public class AtonedHorror extends EntityZombie implements SNMSEntity, EntityFunction, ZombieStatistics, SlayerBoss {
    ...
    public List<EntityDrop> drops() {
        ...
        if (this.tier >= 1) {
            ...
            drops.add(new EntityDrop(SMaterial.UNDEAD_CATALYST, EntityDropType.EXTRAORDINARILY_RARE, 0.01, Bukkit.getPlayer(this.getSpawnerUUID())));
            drops.add(new EntityDrop(SMaterial.REVENANT_CATALYST, EntityDropType.EXTRAORDINARILY_RARE, 0.01, Bukkit.getPlayer(this.getSpawnerUUID())));
            final SItem smiteBook = SItem.of(SMaterial.ENCHANTED_BOOK);
            smiteBook.addEnchantment(EnchantmentType.SMITE, 15);
            drops.add(new EntityDrop(smiteBook.getStack(), EntityDropType.CRAZY_RARE, 0.0025, Bukkit.getPlayer(this.getSpawnerUUID())));
            drops.add(new EntityDrop(SMaterial.BEHEADED_HORROR, EntityDropType.CRAZY_RARE, 0.005, Bukkit.getPlayer(this.getSpawnerUUID())));
            drops.add(new EntityDrop(SMaterial.SNAKE_RUNE, EntityDropType.CRAZY_RARE, 0.005, Bukkit.getPlayer(this.getSpawnerUUID())));
            drops.add(new EntityDrop(SMaterial.SCYTHE_BLADE, EntityDropType.CRAZY_RARE, 0.0033333333333333335, Bukkit.getPlayer(this.getSpawnerUUID())));
            drops.add(new EntityDrop(SMaterial.WARDEN_HEART, EntityDropType.INSANE_RARE, 0.0025, Bukkit.getPlayer(this.getSpawnerUUID())));
            drops.add(new EntityDrop(SMaterial.SHARD_OF_THE_SHREDDED, EntityDropType.CRAZY_RARE, 0.0022222222222222222, Bukkit.getPlayer(this.getSpawnerUUID())));
            drops.add(new EntityDrop(SMaterial.HIDDEN_SHARD_DIAMOND, EntityDropType.CRAZY_RARE, 0.0025, Bukkit.getPlayer(this.getSpawnerUUID())));
            final SItem vcBook = SItem.of(SMaterial.ENCHANTED_BOOK);
            vcBook.addEnchantment(EnchantmentType.VICIOUS, 10);
            drops.add(new EntityDrop(vcBook.getStack(), EntityDropType.INSANE_RARE, 0.002, Bukkit.getPlayer(this.getSpawnerUUID())));
        }
        return drops;
    }

...
import in.godspunky.skyblock.item.armor.hardened.HardenedDiamondHelmet;
import in.godspunky.skyblock.item.armor.hardened.HardenedDiamondLeggings;
...
import in.godspunky.skyblock.item.armor.vanilla.chainmail.ChainmailBoots;
import in.godspunky.skyblock.item.armor.vanilla.chainmail.ChainmailChestplate;
import in.godspunky.skyblock.item.armor.vanilla.chainmail.ChainmailHelmet;
import in.godspunky.skyblock.item.armor.vanilla.chainmail.ChainmailLeggings;
import in.godspunky.skyblock.item.armor.vanilla.diamond.DiamondBoots;
import in.godspunky.skyblock.item.armor.vanilla.diamond.DiamondChestplate;
import in.godspunky.skyblock.item.armor.vanilla.diamond.DiamondHelmet;
import in.godspunky.skyblock.item.armor.vanilla.diamond.DiamondLeggings;
import in.godspunky.skyblock.item.armor.vanilla.golden.GoldenBoots;
import in.godspunky.skyblock.item.armor.vanilla.golden.GoldenChestplate;
import in.godspunky.skyblock.item.armor.vanilla.golden.GoldenHelmet;
import in.godspunky.skyblock.item.armor.vanilla.golden.GoldenLeggings;
import in.godspunky.skyblock.item.armor.vanilla.iron.IronBoots;
import in.godspunky.skyblock.item.armor.vanilla.iron.IronChestplate;
import in.godspunky.skyblock.item.armor.vanilla.iron.IronHelmet;
import in.godspunky.skyblock.item.armor.vanilla.iron.IronLeggings;
import in.godspunky.skyblock.item.armor.vanilla.leather.LeatherBoots;
import in.godspunky.skyblock.item.armor.vanilla.leather.LeatherChestplate;
...
import in.godspunky.skyblock.item.enchanting.EnchantedBook;

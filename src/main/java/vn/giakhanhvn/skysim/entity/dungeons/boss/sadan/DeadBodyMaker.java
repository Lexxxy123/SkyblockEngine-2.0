...
public final class DeadBodyMaker
{
    ...
    public static Object[] createPlayer( Location loc) {
        ...
        playerProfile.getProperties().put("textures", new Property("textures", "", ""));
         Collection<Property> skinProperty = (Collection<Property>)playerProfile.getProperties().get("textures");
        botGameProfile.getProperties().putAll("textures", (Iterable)skinProperty);
    ...
    public static EntityPlayer spawn(final Location location) {
        ...
        for (final Player p : location.getWorld().getPlayers()) {
            ...
            sendPacketBundle(p, new Packet[] { (Packet)new PacketPlayOutScoreboardTeam(scoreboardTeam, 1), (Packet)new PacketPlayOutScoreboardTeam(scoreboardTeam, 0), (Packet)new PacketPlayOutScoreboardTeam(scoreboardTeam, (Collection)Collections.<String>singletonList(name), 3) });

...
public class VoidlingsWardenMob extends BaseZombie
{
    ...
    public void onSpawn(final LivingEntity entity, final SEntity sEntity) {
        ...
        new BukkitRunnable() {
            public void run() {
                ...
                if (Bukkit.getPlayer(UUID.fromString(entity.getMetadata("owner").get(0).asString())) != null) {
                    Bukkit.getPlayer(UUID.fromString(entity.getMetadata("owner").get(0).asString())).damage(VoidlingsWardenMob.this.getDamageDealt(), (Entity)entity);
                    return;
                }
                this.cancel();
            }
        ...
        new BukkitRunnable() {
            public void run() {
                ...
                if (((CraftZombie)entity).getTarget() != null) {
                    VoidlingsWardenMob.this.throwAxe((Entity)entity);
                    SUtil.delay(() -> {
        ...
        new BukkitRunnable() {
            public void run() {
                ...
                VoidlingsWardenMob.this.activeGyroAbi((Entity)entity);
                SUtil.delay(() -> {
    ...
    public void activeGyroAbi(final Entity e) {
        ...
        for (int i = 0; i < 40; ++i) {
            this.a(loc.clone().add(0.0, 0.3, 0.0), (float)(0 + i * 12));
        }

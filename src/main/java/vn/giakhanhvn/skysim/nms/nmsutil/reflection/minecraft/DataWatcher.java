...
public class DataWatcher {
    ...
    public static Object newDataWatcher(final Object entity) throws ReflectiveOperationException {
        return vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWacherConstructorResolver.resolve(new Class[][]{{vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.Entity}}).newInstance(entity);
    }
    ...
    public static class V1_9 {
        ...
        public static Object getItem(final Object dataWatcher, final Object dataWatcherObject) throws ReflectiveOperationException {
            return vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcherMethodResolver.resolve(new ResolverQuery("c", new Class[]{V1_9.DataWatcherObject})).invoke(dataWatcher, dataWatcherObject);
        }

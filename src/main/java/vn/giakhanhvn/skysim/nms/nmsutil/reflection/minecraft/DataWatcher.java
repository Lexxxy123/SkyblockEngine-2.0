...
public class DataWatcher
{
    ...
    public static Object newDataWatcher(final Object entity) throws ReflectiveOperationException {
        return vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWacherConstructorResolver.resolve((Class<?>[][])new Class[][] { { vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.Entity } }).newInstance(entity);
    }
    ...
    public static int getValueType(final Object value) {
        ...
        else if (value != null && value.getClass().equals(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.ItemStack)) {
            type = 5;
        }
        else if (value != null && (value.getClass().equals(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.ChunkCoordinates) || value.getClass().equals(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.BlockPosition))) {
            type = 6;
        }
        else if (value != null && value.getClass().equals(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.Vector3f)) {
            type = 7;
        }
        return type;
    }
    ...
    static {
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.classResolver = new ClassResolver();
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver = new NMSClassResolver();
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.ItemStack = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolveSilent("ItemStack");
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.ChunkCoordinates = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolveSilent("ChunkCoordinates");
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.BlockPosition = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolveSilent("BlockPosition");
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.Vector3f = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolveSilent("Vector3f");
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcher = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolveSilent("DataWatcher");
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.Entity = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolveSilent("Entity");
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.TIntObjectMap = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.classResolver.resolveSilent("gnu.trove.map.TIntObjectMap", "net.minecraft.util.gnu.trove.map.TIntObjectMap");
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWacherConstructorResolver = new ConstructorResolver(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcher);
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcherFieldResolver = new FieldResolver(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcher);
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.TIntObjectMapMethodResolver = new MethodResolver(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.TIntObjectMap);
        vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcherMethodResolver = new MethodResolver(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcher);
    }
    ...
    public static class V1_9
    {
        ...
        public static Object setItem(final Object dataWatcher, final int index, final Object dataWatcherItem) throws ReflectiveOperationException {
            final Map<Integer, Object> map = (Map<Integer, Object>)vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcherFieldResolver.resolveByLastTypeSilent(Map.class).get(dataWatcher);
        ...
        public static Object setValue(final Object dataWatcher, final Object dataWatcherObject, final Object value) throws ReflectiveOperationException {
            vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcherMethodResolver.resolve("set").invoke(dataWatcher, dataWatcherObject, value);
            return dataWatcher;
        }
        
        public static Object getItem(final Object dataWatcher, final Object dataWatcherObject) throws ReflectiveOperationException {
            return vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcherMethodResolver.resolve(new ResolverQuery("c", (Class<?>[])new Class[] { V1_9.DataWatcherObject })).invoke(dataWatcher, dataWatcherObject);
        }
        ...
        public static Object getValue(final Object dataWatcher, final Object dataWatcherObject) throws ReflectiveOperationException {
            return vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcherMethodResolver.resolve("get").invoke(dataWatcher, dataWatcherObject);
        }
        ...
        static {
            V1_9.DataWatcherItem = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolveSilent("DataWatcher$Item");
            V1_9.DataWatcherObject = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolveSilent("DataWatcherObject");
        }
        ...
        public enum ValueType
        {
            ...
            private ValueType(final String className, final String[] fieldNames) {
                try {
                    this.type = new FieldResolver(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolve(className)).resolve(fieldNames).get(null);
                }
            ...
            private ValueType(final String className, final int index) {
                try {
                    this.type = new FieldResolver(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolve(className)).resolveIndex(index).get(null);
                }
                catch (final Exception e) {
                    if (Minecraft.VERSION.newerThan(Minecraft.Version.v1_9_R1)) {
            ...
            private ValueType(final String className, final int index, final int offset) {
                int firstObject = 0;
                try {
                    final Class<?> clazz = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolve(className);
    ...
    public static class V1_8
    {
        ...
        public static Object newWatchableObject(final int index, final Object value) throws ReflectiveOperationException {
            return newWatchableObject(vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.getValueType(value), index, value);
        }
        ...
        public static Object setValue(final Object dataWatcher, final int index, final Object value) throws ReflectiveOperationException {
            final int type = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.getValueType(value);
            final Map map = (Map)vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.DataWatcherFieldResolver.resolveByLastType(Map.class).get(dataWatcher);
        ...
        static {
            V1_8.WatchableObject = vn.giakhanhvn.skysim.nms.nmsutil.reflection.minecraft.DataWatcher.nmsClassResolver.resolveSilent("WatchableObject", "DataWatcher$WatchableObject");
        }
    }
}

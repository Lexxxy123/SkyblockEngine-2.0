...
public class RecipeBookGUI extends GUI
{
    ...
    public void onOpen(final GUIOpenEvent e) {
        ...
        this.set(23, SUtil.getStack(Sputnik.trans("&aCrafting Table"), Material.WORKBENCH, (short)0, 1, Arrays.<String>asList(Sputnik.trans("&7Craft this recipe by using a"), Sputnik.trans("&7Crafting Table"))));

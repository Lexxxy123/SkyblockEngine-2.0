    ...
    public void onOpen(final GUIOpenEvent e) {
        ...
        new BukkitRunnable() {
            public void run() {
                ...
                meta.setLore((List)Arrays.<String>asList(Sputnik.trans("&7Obtain the &dCookie Buff"), Sputnik.trans("&7from booster cookies in the"), Sputnik.trans("&7hub's community shop."), " ", Sputnik.trans(text_ + "&7: " + PlayerUtils.getCookieDurationDisplayGUI(player)), " ", ChatColor.YELLOW + "Click to get all the info!"));

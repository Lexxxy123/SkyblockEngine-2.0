...
public class CatacombsSkill extends Skill
{
    ...
    public List<String> getDescription() {
        return Arrays.<String>asList("Complete this dungeon to earn", "experience and unlock new", "rewards!");
    }
    
    @Override
    public List<String> getLevelUpInformation(final int level, final int lastLevel, final boolean showOld) {
        return Arrays.<String>asList(Sputnik.trans("&7Level " + SUtil.toRomanNumeral(level) + ": &7Increasing the stats"), Sputnik.trans("&7of your Dungeon items by"), Sputnik.trans("&c" + level * 5 + "% &7while in &cThe"), Sputnik.trans("&cCatacombs&7."));
    }

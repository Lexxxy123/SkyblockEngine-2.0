...
public class FarmingSkill extends Skill
{
    ...
    public List<String> getDescription() {
        return Arrays.<String>asList("Harvest crops and shear sheep to", "earn Farming XP!");
    }
    ...
    public List<String> getLevelUpInformation(final int level, final int lastLevel, final boolean showOld) {
        ...
        return Arrays.<String>asList(ChatColor.WHITE + " Grants " + dropChance + "%" + ChatColor.WHITE + " chance", ChatColor.WHITE + " to drop 2x crops.", ChatColor.DARK_GRAY + "+" + ChatColor.GREEN + healthPlus + " " + ChatColor.RED + "❤ Health");
    }

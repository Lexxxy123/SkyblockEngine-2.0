...
public class MiningSkill extends Skill
{
    ...
    public List<String> getDescription() {
        return Arrays.<String>asList("Spelunk islands for ores and", "valuable materials to earn", "Mining XP!");
    }
    ...
    public List<String> getLevelUpInformation(final int level, final int lastLevel, final boolean showOld) {
        ...
        return Arrays.<String>asList(ChatColor.WHITE + " Grants " + dropChance + "%" + ChatColor.WHITE + " chance", ChatColor.WHITE + " to drop " + ((level > 25) ? "3" : "2") + "x ores.", ChatColor.DARK_GRAY + "+" + ChatColor.GREEN + ((level >= 15) ? "2" : "1") + " " + ChatColor.GREEN + "❈ Defense");
    }

...
public class ForagingSkill extends Skill
{
    ...
    public List<String> getDescription() {
        return Arrays.<String>asList("Cut trees and forage for other", "plants to earn Foraging XP!");
    }
    ...
    public List<String> getLevelUpInformation(final int level, final int lastLevel, final boolean showOld) {
        ...
        return Arrays.<String>asList(ChatColor.WHITE + " Grants " + dropChance + "%" + ChatColor.WHITE + " chance", ChatColor.WHITE + " to drop " + ((level > 25) ? "3" : "2") + "x logs.", ChatColor.DARK_GRAY + "+" + ChatColor.GREEN + ((level >= 15) ? "2" : "1") + " " + ChatColor.RED + "❁ Strength");
    }

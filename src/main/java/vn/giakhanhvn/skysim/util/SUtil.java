...
public class SUtil
{
        ...
        new BukkitRunnable() {
            public void run() {
                ...
                if (target.get() == null) {
                    ...
                    final LivingEntity setTarget = SUtil.<LivingEntity>getRandom(possible);
                    if (setTarget == null) {
                        return;
                    }
    ...
    public static ItemStack getStack(final String name, final Material material, final short data, final int amount, final String... lore) {
        return getStack(name, material, data, amount, Arrays.<String>asList(lore));
    }
    ...
    public static ItemStack getSingleLoreStack(final String name, final Material material, final short data, final int amount, final String lore) {
        ...
        return getStack(name, material, data, amount, (String[])l.<String>toArray(new String[0]));
    }
    ...
    public static <T> T[] unnest(final T[][] array2d, final Class<T> clazz) {
        final T[] array = (T[])Array.newInstance(clazz, SUtil.<T>deepLength(array2d));
        int i = 0;
        int c = 0;
    ...
    static {
        ...
        CRIT_SPECTRUM = Arrays.<ChatColor>asList(ChatColor.WHITE, ChatColor.WHITE, ChatColor.YELLOW, ChatColor.GOLD, ChatColor.RED, ChatColor.RED);
        VISIBLE_COLOR_SPECTRUM = Arrays.<ChatColor>asList(ChatColor.DARK_GREEN, ChatColor.DARK_AQUA, ChatColor.DARK_RED, ChatColor.DARK_PURPLE, ChatColor.GOLD, ChatColor.GREEN, ChatColor.AQUA, ChatColor.RED, ChatColor.LIGHT_PURPLE, ChatColor.YELLOW, ChatColor.WHITE);

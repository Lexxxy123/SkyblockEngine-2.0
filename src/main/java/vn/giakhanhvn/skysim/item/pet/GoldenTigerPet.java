    ...
    public List<PetAbility> getPetAbilities(final SItem instance) {
        ...
        final List<PetAbility> abilities = new ArrayList<PetAbility>(Collections.singletonList(new PetAbility() {
            ...
            public List<String> getDescription(final SItem instance) {
                return Arrays.<String>asList(Sputnik.trans("&7Grant &e1% &7of your &c❁ Strength"), Sputnik.trans("&7as &b✯ Magic Find"));
            }
        }));
        if (instance.getRarity().isAtLeast(Rarity.EPIC)) {
            abilities.add(new PetAbility() {
                ...
                @Override
                public List<String> getDescription(final SItem instance) {
                    return Arrays.<String>asList(Sputnik.trans("&7For every &c30⫽ Ferocity&7,"), Sputnik.trans("&7adds &c" + fero.toPlainString() + " &7base damage"), ChatColor.GRAY + "to your weapons.");
                }
            });
        }
        ...
        if (instance.getRarity().isAtLeast(Rarity.MYTHIC)) {
            abilities.add(new PetAbility() {
                ...
                @Override
                public List<String> getDescription(final SItem instance) {
                    return Arrays.<String>asList(Sputnik.trans("&7For each digit in your &bBits"), Sputnik.trans("&bpurse &7gain &c+" + buffstat3 + "⫽ Ferocity"), Sputnik.trans("&7and &b+" + buffstat2 + "✯ Magic Find"));
                }
            });
        }
        return abilities;

...
public class CrackedPiggyBank implements AccessoryStatistics, MaterialFunction
{
    ...
    public List<String> getListLore() {
        return Arrays.<String>asList("Saves " + ChatColor.RED + "75%" + ChatColor.GRAY + " of your coins on death.", "Only when in player inventory.", ChatColor.RED + "Very fragile!", "", ChatColor.DARK_GRAY + "Triggers when losing 20k+ coins.");
    }
}

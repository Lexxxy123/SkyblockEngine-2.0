...
public enum SMaterial
{
    ...
    HIDDEN_DONATOR_HELMET(Material.STAINED_GLASS, (Class<?>)USSRHelmet.class, (short)14), 
    HIDDEN_DT2_HELMET(Material.STAINED_GLASS, (Class<?>)renegade450Helmet.class, (short)14), 
    HIDDEN_GYROKINETIC_WAND(Material.BLAZE_ROD, (Class<?>)GyrokineticWand.class), 
    HIDDEN_GOLDEN_TIGER_2022(Material.SKULL_ITEM, (Class<?>)GoldenTigerPet.class), 
    HIDDEN_CHIMMY_PET(Material.SKULL_ITEM, (Class<?>)ChimmyPet.class), 
    HIDDEN_ARCHIVY(Material.SKULL_ITEM, (Class<?>)ArchivyPet.class), 
    HIDDEN_ARAGORN_PET(Material.SKULL_ITEM, (Class<?>)AragornPet.class), 
    HIDDEN_KP56_PET(Material.SKULL_ITEM, (Class<?>)KP56Pet.class), 
    ...
    HIDDEN_COMPRESSED_BITS(Material.DIAMOND, (Class<?>)CompressedBits.class), 
    HIDDEN_GYRO_EYE(Material.EYE_OF_ENDER, (Class<?>)GyrokineticEye.class), 
    HIDDEN_SOUL_WHIP(Material.FISHING_ROD, (Class<?>)SoulWhip.class), 
    HIDDEN_VOIDLINGS_WARDEN_HELMET(Material.SKULL_ITEM, (Class<?>)VoidlingsWardenHelmet.class), 
    HIDDEN_VOID_FRAGMENT(Material.EYE_OF_ENDER, (Class<?>)VoidFragment.class), 
    HIDDEN_DEMONS_PEARL(Material.SKULL_ITEM, (Class<?>)DemonsPearl.class), 
    HIDDEN_COMPRESSED_VOID_FRAG(Material.SKULL_ITEM, (Class<?>)CompressedVoidFrag.class), 
    HIDDEN_VOIDLINGS_PET(Material.SKULL_ITEM, (Class<?>)VoidlingsPet.class), 
    HIDDEN_DIMOONIZARY_DAGGER(Material.DIAMOND_SWORD, (Class<?>)DimoonizaryDagger.class), 
    HIDDEN_DIMOON_GEM(Material.SKULL_ITEM, (Class<?>)DimoonCatalyst.class), 
    HIDDEN_DIMOON_FRAG(Material.SKULL_ITEM, (Class<?>)DimoonFragment.class), 
    ...
    HIDDEN_GIGACHAD_HELMET(Material.SKULL_ITEM, (Class<?>)GigachadHelmet.class), 
    HIDDEN_GIGACHAD_CHESTPLATE(Material.LEATHER_CHESTPLATE, (Class<?>)GigachadChestplate.class), 
    HIDDEN_GIGACHAD_LEGGINGS(Material.LEATHER_LEGGINGS, (Class<?>)GigachadLeggings.class), 
    HIDDEN_GIGACHAD_BOOTS(Material.LEATHER_BOOTS, (Class<?>)GigachadBoots.class), 
    HIDDEN_MINICHAD_HELMET(Material.SKULL_ITEM, (Class<?>)MinichadHelmet.class), 
    HIDDEN_MINICHAD_CHESTPLATE(Material.LEATHER_CHESTPLATE, (Class<?>)MinichadChestplate.class), 
    HIDDEN_MINICHAD_LEGGINGS(Material.LEATHER_LEGGINGS, (Class<?>)MinichadLeggings.class), 
    HIDDEN_MINICHAD_BOOTS(Material.LEATHER_BOOTS, (Class<?>)MinichadBoots.class), 
    ...
    HIDDEN_QUANTUMFLUX_POWER_ORB(Material.SKULL_ITEM, (Class<?>)QuantumfluxPowerOrb.class), 
    ...
    DIAMOND_TROPHY_SADAN(Material.SKULL_ITEM, (Class<?>)DiamondSadanTrophy.class), 
    ...
    FARMING_TALISMAN(Material.SKULL_ITEM, (Class<?>)FarmingTalisman.class), 
    EXTERMINATOR(Material.IRON_SWORD, (Class<?>)Exterminator.class), 
    ...
    GUNGA_PET(Material.SKULL_ITEM, (Class<?>)GungaPet.class), 
    ...
    public static SMaterial getSpecEquivalent(final Material material, short data) {
        ...
        final List<SMaterial> results = Arrays.<SMaterial>stream(values()).filter(m -> m.craft && m.getCraftMaterial() == material).collect(Collectors.toList());
    ...
    static {
        ...
        SMaterial.YOUNG_DRAGON_SET = SMaterial.<YoungDragonSet>registerArmorSet(YoungDragonSet.class);
        SMaterial.SUPERIOR_DRAGON_SET = SMaterial.<SuperiorDragonSet>registerArmorSet(SuperiorDragonSet.class);
        SMaterial.WISE_DRAGON_SET = SMaterial.<WiseDragonSet>registerArmorSet(WiseDragonSet.class);
        SMaterial.UNSTABLE_DRAGON_SET = SMaterial.<UnstableDragonSet>registerArmorSet(UnstableDragonSet.class);
        SMaterial.STRONG_DRAGON_SET = SMaterial.<StrongDragonSet>registerArmorSet(StrongDragonSet.class);
        SMaterial.OLD_DRAGON_SET = SMaterial.<OldDragonSet>registerArmorSet(OldDragonSet.class);
        SMaterial.PROTECTOR_DRAGON_SET = SMaterial.<ProtectorDragonSet>registerArmorSet(ProtectorDragonSet.class);
        SMaterial.LAPIS_ARMOR_SET = SMaterial.<LapisArmorSet>registerArmorSet(LapisArmorSet.class);
        SMaterial.MINER_SET = SMaterial.<MinerSet>registerArmorSet(MinerSet.class);
        SMaterial.NECRONS_SET = SMaterial.<NecronFullSet>registerArmorSet(NecronFullSet.class);
        SMaterial.STORMS_SET = SMaterial.<StormFullSet>registerArmorSet(StormFullSet.class);
        SMaterial.SORROW_SET = SMaterial.<SorrowArmorSet>registerArmorSet(SorrowArmorSet.class);
        SMaterial.GIGACHAD_SET = SMaterial.<GigachadSet>registerArmorSet(GigachadSet.class);
        SMaterial.MINICHAD_SET = SMaterial.<MinichadSet>registerArmorSet(MinichadSet.class);
    }

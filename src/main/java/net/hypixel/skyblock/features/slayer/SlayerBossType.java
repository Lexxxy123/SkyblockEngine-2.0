...
public class SlayerBossType {
    ...
    static {
        ...
        REVENANT_HORROR_V = new SlayerBossType("revenant_horror_v", "Revenant Horror", SEntityType.ATONED_HORROR, 5, "Excruiating", SlayerMobType.ZOMBIE, 10000000, 3400, 1500, 6000, 0, SlayerBossType.HEAL, SlayerBossType.EXPLOSION, SlayerBossType.ONEHIT);

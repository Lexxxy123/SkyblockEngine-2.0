...
public class SlayerBossType {
    ...
    public static final SlayerBossType REVENANT_HORROR_V = new SlayerBossType("revenant_horror_v", "Revenant Horror", SEntityType.ATONED_HORROR, 5, "Excruiating", SlayerMobType.ZOMBIE, 100000000, 3400, 1500, 6000, 100000, HEAL, EXPLOSION, ONEHIT);
    ...
    public static final SlayerBossType VOIDGLOOM_SERAPH_I = new SlayerBossType("voidgloom_seraph_i", "Voidgloom Seraph", SEntityType.VOIDGLOOM_SERAPH, 1, "Beginner", SlayerMobType.ENDERMAN, 30000000, 120000, 5, 2750, 2000, DISSONANCE, HITSHIELD);
    public static final SlayerBossType VOIDGLOOM_SERAPH_II = new SlayerBossType("voidgloom_seraph_ii", "Voidgloom Seraph", SEntityType.VOIDGLOOM_SERAPH, 2, "Strong", SlayerMobType.ENDERMAN, 150000000, 1000000, 25, 6600, 7500, DISSONANCE, HITSHIELD, YANG_GLYPHS);
    public static final SlayerBossType VOIDGLOOM_SERAPH_III = new SlayerBossType("voidgloom_seraph_iii", "Voidgloom Seraph", SEntityType.VOIDGLOOM_SERAPH, 3, "Challenging", SlayerMobType.ENDERMAN, 666000000, 1200000, 100, 11000, 20000, DISSONANCE, HITSHIELD, YANG_GLYPHS, NUKEKUBI);

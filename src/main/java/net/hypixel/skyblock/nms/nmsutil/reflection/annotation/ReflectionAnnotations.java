...
import net.hypixel.skyblock.nms.nmsutil.reflection.annotation.Class;
import net.hypixel.skyblock.nms.nmsutil.reflection.annotation.Field;
import net.hypixel.skyblock.nms.nmsutil.reflection.annotation.Method;

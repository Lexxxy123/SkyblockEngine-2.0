...
import net.hypixel.skyblock.entity.dungeons.watcher.Cuboid;
...
implements Listener {
    ...
    private final List<HeadsOnWall> how = new ArrayList<HeadsOnWall>();
    private final List<String> spawnedMob = new ArrayList<String>();
    ...
    public void spawnWatcher(Location loc) {
        ...
        this.ewatcher = stand;
        this.ewatcher.setCustomName(Watcher.trans("&e\ufd3e &c&lThe Watcher &e\ufd3f"));

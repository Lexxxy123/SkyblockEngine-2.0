            ...
            public void run() {
                ...
                if (((CraftZombie)entity).getTarget() != null) {
                    ...
                    SUtil.delay(() -> {
                        ...
                        PlayerDisguise val$pl = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
                    }, 20L);
                    SUtil.delay(() -> {
                        LivingEntity val$entity2 = entity;
                        PlayerDisguise val$pl2 = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
                    }, 30L);
                    SUtil.delay(() -> {
                        LivingEntity val$entity3 = entity;
                        PlayerDisguise val$pl3 = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
                    }, 40L);
                    SUtil.delay(() -> {
                        LivingEntity val$entity4 = entity;
                        PlayerDisguise val$pl4 = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
                    }, 50L);
                    SUtil.delay(() -> {
                        LivingEntity val$entity5 = entity;
                        PlayerDisguise val$pl5 = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
                    }, 60L);
                    SUtil.delay(() -> {
                        LivingEntity val$entity6 = entity;
                        PlayerDisguise val$pl6 = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
                    }, 70L);
                    SUtil.delay(() -> {
                        LivingEntity val$entity7 = entity;
                        PlayerDisguise val$pl7 = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
                    }, 80L);
                    SUtil.delay(() -> {
                        LivingEntity val$entity8 = entity;
                        PlayerDisguise val$pl8 = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
                    }, 90L);
                    SUtil.delay(() -> {
                        LivingEntity val$entity9 = entity;
                        PlayerDisguise val$pl9 = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
                    }, 100L);
                    SUtil.delay(() -> {
                        LivingEntity val$entity10 = entity;
                        PlayerDisguise val$pl10 = pl;
                        CryptDreadlord.this.throwSkull(entity, pl);
        ...
        new BukkitRunnable(){
            ...
            public void run() {
                ...
                for (Entity entities : entity.getWorld().getNearbyEntities(entity.getLocation().add(entity.getLocation().getDirection().multiply(1.0)), 1.5, 1.5, 1.5)) {
                    Player target2;
                    if (CryptDreadlord.this.skullShoot || !(entities instanceof Player) || (target2 = (Player)entities).getGameMode() == GameMode.CREATIVE || target2.getGameMode() == GameMode.SPECTATOR || target2.hasMetadata("NPC") || target2.getNoDamageTicks() == 7 || SUtil.random(0, 10) > 8) continue;

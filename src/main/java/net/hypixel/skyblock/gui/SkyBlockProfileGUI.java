...
extends GUI {
    ...
    public void onOpen(GUIOpenEvent e2) {
        ...
        this.set(22, SUtil.getStack(ChatColor.WHITE + "\u2726 Speed " + SUtil.commaify(statistics.getSpeed().addAll() * 100.0), Material.SUGAR, (short)0, 1, ChatColor.GRAY + "Speed increases your walk speed.", " ", ChatColor.GRAY + "You are " + ChatColor.GREEN + (statistics.getSpeed().addAll() * 100.0 - 100.0) + "% " + ChatColor.GRAY + "faster!"));

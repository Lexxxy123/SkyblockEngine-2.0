...
extends GUI {
    ...
    public void onOpen(GUIOpenEvent e) {
        ...
        this.set(new GUIClickableItem(){
            ...
            @Override
            public ItemStack getItem() {
                return SUtil.getStack(ChatColor.YELLOW + "" + ChatColor.BOLD + "PREPARING", Material.CHEST, (short)0, 1, ChatColor.DARK_GRAY + "Fire Sale", "", ChatColor.GRAY + "Elizabeth is currently", ChatColor.GRAY + "preparing the next fire", ChatColor.GRAY + "sale.");
            }
        });
        this.set(new GUIClickableItem(){
        ...
        this.set(new GUIClickableItem(){
            ...
            @Override
            public ItemStack getItem() {
                return SUtil.getStack(ChatColor.GOLD + "Previous Fire Sale", Material.BOOK, (short)0, 1, ChatColor.translateAlternateColorCodes((char)'&', (String)"&7There have been &c0 &7fire"), ChatColor.translateAlternateColorCodes((char)'&', (String)"&7sales before"), "", ChatColor.YELLOW + "Click to browse!");
            }
        });
    }
}

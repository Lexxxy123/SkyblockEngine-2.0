    ...
    public void onOpen(final GUIOpenEvent e) {
        ...
        this.set(new GUIClickableItem() {
            ...
            public void run(final InventoryClickEvent e) {
                ...
                if (User.getUser(p.getUniqueId()).getBits() >= 2000) {
                    User.getUser(p.getUniqueId()).subBits(2000);
            ...
            public ItemStack getItem() {
                return SUtil.getStack(Sputnik.trans("&aTravel to: &cWithering Ruins"), Material.MINECART, (short) 0, 1, Sputnik.trans("&7Following &dArlly &7rails and travel into"), Sputnik.trans("&7a mysterious place under the &eGiants Island"), Sputnik.trans("&cBe Careful! &4Something, is there..."), Sputnik.trans("&7"), Sputnik.trans("&7Cost for a Minecart Ride"), Sputnik.trans("&b2,000 Bits"), Sputnik.trans("&7"), Sputnik.trans((User.getUser(player.getUniqueId()).getBits() >= 2000) ? "&eClick to travel" : "&cYou cannot afford this!"));
            }
        });
    }
}

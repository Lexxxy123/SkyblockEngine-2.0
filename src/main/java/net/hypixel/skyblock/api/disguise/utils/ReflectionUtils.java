...
import net.hypixel.skyblock.api.disguise.utils.ConcurrentReferenceHashMap;
...
public abstract class ReflectionUtils {
    ...
    public static Field getDeclaredFieldByIndex(Class<?> src, Class<?> fieldType, int index) throws NoSuchFieldException {
        return ReflectionUtils.getFieldFromArrayAndIndex(src.getDeclaredFields(), fieldType, index);
    }

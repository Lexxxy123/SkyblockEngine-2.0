...
Ability {
    ...
    public void onAbilityUse(final Player player, final SItem sItem) {
        ...
        ArmorStand stand2 = (ArmorStand)player.getWorld().spawn(stand.getLocation().add(stand.getLocation().getDirection().multiply(1)), ArmorStand.class);
        ...
        ArmorStand stand10 = (ArmorStand)player.getWorld().spawn(stand9.getLocation().add(stand9.getLocation().getDirection().multiply(1)), ArmorStand.class);

...
public class WardenSummoningEye implements SkullStatistics, MaterialFunction {
    ...
    public String getLore() {
        return "Use this at the " + ChatColor.DARK_PURPLE + "Ender Altar" + ChatColor.GRAY + " in the " + ChatColor.DARK_PURPLE + "Void Sepulture" + ChatColor.GRAY + " to summon Voidlings Warden!";
    }

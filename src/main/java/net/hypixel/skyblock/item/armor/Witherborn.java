...
public class Witherborn {
    ...
    public void spawnWither() {
        ...
        w2.setMetadata("GiantSword", (MetadataValue)new FixedMetadataValue((Plugin)SkyBlock.getPlugin(), (Object)0));
        w2.setMetadata("NoAffect", (MetadataValue)new FixedMetadataValue((Plugin)SkyBlock.getPlugin(), (Object)0));
        w2.setMetadata("Ire", (MetadataValue)new FixedMetadataValue((Plugin)SkyBlock.getPlugin(), (Object)0));
        this.w = w2;
        new BukkitRunnable(){

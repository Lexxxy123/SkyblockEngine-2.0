 ...
 */
package net.hypixel.skyblock.item.armor.final_destination;
...
public class FinalDestinationBoots implements ToolStatistics, MaterialFunction, LeatherArmorStatistics {
    @Override
